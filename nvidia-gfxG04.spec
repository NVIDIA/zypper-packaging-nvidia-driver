...
# and install kernel module; Leap 42.3/sle12-sp3 needs this to recompile
# module after having uninstalled drm-kmp package (%triggerpostun)
%if (0%{?suse_version} >= 1330 && 0%{?is_opensuse}) || (0%{?suse_version} < 1320 && 0%{?sle_version} >= 120300)
...
# if kernel-<flavor>-devel gets updated or drm-kmp-default gets uninstalled
